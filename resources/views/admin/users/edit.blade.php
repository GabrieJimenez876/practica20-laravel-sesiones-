                ...
                <div class="p-6">
                    <form method="POST" action="{{ route('admin.users.update', $user) }}">
                        ...
                        <div class="mb-4">
                            ...
                            <input id="password" name="password" type="password" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                        ...
                        <div class="flex items-center justify-between">
                            ...
                            <button type="submit" class="rounded-md bg-blue-600 px-4 py-2 text-sm font-semibold text-white hover:bg-blue-700">Actualizar usuario</button>
                        </div>
                    </form>
                </div>
            </div>
