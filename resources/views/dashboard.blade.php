        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="mt-6 grid gap-6 md:grid-cols-2">
                <div class="rounded-xl border border-gray-200 bg-white p-6 shadow-sm">
                    ...
                    <p class="mt-2 text-sm text-gray-600">Revisa y actualiza tu información personal.</p>
                    <a href="{{ route('profile.edit') }}" class="mt-4 inline-flex items-center rounded-md bg-blue-600 px-4 py-2 text-sm font-semibold text-white hover:bg-blue-700">Ver perfil</a>
                </div>
